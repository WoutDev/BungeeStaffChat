...
public class StaffChat extends Command
{
    ...
    public void execute(CommandSender sender, String[] args)
    {
        ...
        if (sender instanceof ProxiedPlayer)
        {
            ...
            if (StaffChatDisable.disabled.contains(pp.getUniqueId()))
            {
                pp.sendMessage(ChatColor.translateAlternateColorCodes('&', Main.getLang()
                                                                               .getString("sc-disabled-enable-first")));
                return;
            }
            ...
            if (checkArgs(sender, args))
            {
                ...
                {
                    if (pl.hasPermission("staffchat.receive") || pl.hasPermission("staffchat.*") ||
                        pl.hasPermission("staffchat.use"))
                    {
                        ...
                        {
                            pl.sendMessage(ChatColor.translateAlternateColorCodes('&', Main.getConfig()
                                                                                           .getString(
                                                                                                   "staffchat-template")
                                                                                           .replaceAll("%player%",
                                                                                                       pp.getName())
                        ...
                        else
                        {
                            pl.sendMessage(ChatColor.translateAlternateColorCodes('&', Main.getConfig()
                                                                                           ...
                                                                                           .replaceAll("%player%",
                                                                                                       pp.getName()))
                                                    .replaceAll("%message%", Matcher.quoteReplacement(s))
                                                    .replaceAll("%server%",
                                                                ChatColor.translateAlternateColorCodes('&', server)));
                        }
                    }
                }
            }
        ...
        else
        {
            if (checkArgs(sender, args))
            {
                ...
                s = sb.toString();
                server = ChatColor.translateAlternateColorCodes('&', Main.getLang()
                                                                         .getString("console-send-message-server"));
                for (ProxiedPlayer pl : ProxyServer.getInstance().getPlayers())
                {
                    if (pl.hasPermission("staffchat.receive") || pl.hasPermission("staffchat.*") ||
                        pl.hasPermission("staffchat.use"))
    ...
    private boolean checkArgs(CommandSender sender, String[] args)
    {
        ...
        {
            sender.sendMessage(
                    ChatColor.translateAlternateColorCodes('&', Main.getLang().getString("specify-message")));
            return false;
        }
        return true;
    }
